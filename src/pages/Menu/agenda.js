import { View, Text, ScrollView, TouchableNativeFeedback, Image, Pressable, FlatList, Alert } from 'react-native'
...
export default function AgendaPengawas({ navigation, route }) {
  ...
  const __getDataBaseAPI = () => {
    axios.post(apiURL + 'agenda').then(res => {
    ...
    <View style={{
      ...
      <View style={{
        ...
        <FlatList data={data} renderItem={({ item, index }) => {
          return (
            <Pressable onPress={() => navigation.navigate('AgendaDetail', item)}>
