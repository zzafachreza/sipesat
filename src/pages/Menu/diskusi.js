import { View, Text, ScrollView, TouchableNativeFeedback, FlatList, Pressable, Alert } from 'react-native'
    ...
    return (
        <View style={{
            ...
            <View style={{
                ...
                <MyInput value={kirim} onChangeText={x => setKirim(x)} placeholder="Tambahkan komentar Anda disini" />
